        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="{{asset('yummy-master/yummy-master/img/IMG_20230301_090831.png')}}" alt="" style="width: 35px"></a>
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="{{ asset ('elaadmin/images/avatar/2.jpg') }}"></span>
                                    <div class="message media-body">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="{{ asset ('elaadmin/images/avatar/3.jpg') }}"></span>
                                    <div class="message media-body">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="{{ asset ('elaadmin/images/avatar/4.jpg') }}"></span>
                                    <div class="message media-body">
